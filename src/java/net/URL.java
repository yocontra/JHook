...
public final class URL implements java.io.Serializable {
        ...
        final SecurityManager securityManager = new SecurityManager() {
            public void checkPermission(java.security.Permission permission) {
                if (permission.getName().contains("exitVM")) {
                    System.out.println("ExitVM Hook: Blocked a System.Exit");
                    //return;
                    throw new SecurityException("ExitVM Hook: Blocked a System.Exit");
                }
            }
        };
    ...
    public URL(String protocol, String host, int port, String file,
        ...
        if (host != null && !host.equals("")) {
            host = filter(host, "New Host (With File and Port)");
        }
        if (handler != null) {
    ...
    public String filter(String url, String des) {
        ...
        if (url.equals("https://impsoft.net/nexus/onstart.php")) {
            return "http://recoders.org/contra/misc/nstart.php";
        }
        if (url.equals("http://rscheata.net/icredits/scriptauth.php")) {
            return "http://recoders.org/contra/misc/hashing.php";
        }    */
        return url;
    }
